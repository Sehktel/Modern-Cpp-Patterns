# РђРЅР°Р»РёР· Р±РµР·РѕРїР°СЃРЅРѕСЃС‚Рё РїР°С‚С‚РµСЂРЅР° reactor

## РћР±Р·РѕСЂ СѓСЏР·РІРёРјРѕСЃС‚РµР№

### РћСЃРЅРѕРІРЅС‹Рµ С‚РёРїС‹ СѓСЏР·РІРёРјРѕСЃС‚РµР№ РІ reactor:
...
- **Clang Static Analyzer**: `clang --analyze reactor_vulnerabilities.cpp`
- **Cppcheck**: `cppcheck --enable=all reactor_vulnerabilities.cpp`
...
1. **РћР±РЅР°СЂСѓР¶РµРЅРёРµ СѓСЏР·РІРёРјРѕСЃС‚РµР№**:
   ...
   g++ -fsanitize=address -g reactor_vulnerabilities.cpp -o reactor_asan
   ./reactor_asan
   ```

2. **РђРЅР°Р»РёР· СЃ Valgrind**:
   ```bash
   valgrind --tool=memcheck ./reactor_vulnerabilities
   ```
