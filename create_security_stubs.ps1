...
"@
                $readmeContent = $readmeContent -replace '\{PATTERN_NAME\}', $patternName
                $readmeContent = $readmeContent -replace '\{pattern\}', $patternName
