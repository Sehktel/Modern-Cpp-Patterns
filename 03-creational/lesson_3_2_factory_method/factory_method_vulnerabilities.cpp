...
// ============================================================================
//
// Этот файл демонстрирует типичные уязвимости в паттерне Factory Method:
// 1. Buffer Overflow при создании объектов
// 2. Memory Leaks при исключениях
// 3. Type Confusion при unsafe casting
// 4. Integer Overflow в вычислениях размеров
//
// ИНСТРУМЕНТЫ ДЛЯ АНАЛИЗА:
// - AddressSanitizer: g++ -fsanitize=address -g factory_method_vulnerabilities.cpp
// - UBSanitizer: g++ -fsanitize=undefined -g factory_method_vulnerabilities.cpp
// - Valgrind: valgrind --tool=memcheck ./factory_method_vulnerabilities
//
