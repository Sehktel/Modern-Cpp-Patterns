...
// ============================================================================
//
// Этот файл демонстрирует типичные уязвимости в паттерне Builder:
// 1. Buffer Overflow при построении больших объектов
// 2. Integer Overflow при вычислении размеров
// 3. Validation Bypass через method chaining
// 4. Incomplete objects - использование до завершения построения
// 5. State pollution между вызовами build()
//
// ИНСТРУМЕНТЫ ДЛЯ АНАЛИЗА:
// - AddressSanitizer: g++ -fsanitize=address -g builder_vulnerabilities.cpp
// - UBSanitizer: g++ -fsanitize=undefined -g builder_vulnerabilities.cpp
// - Valgrind: valgrind --tool=memcheck ./builder_vulnerabilities
//
