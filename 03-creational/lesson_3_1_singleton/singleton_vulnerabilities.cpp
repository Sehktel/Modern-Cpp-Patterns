...
// ============================================================================
//
// Этот файл демонстрирует типичные уязвимости в паттерне Singleton:
// 1. Race Condition при инициализации
// 2. Memory Leaks при исключениях  
// 3. Use-After-Free при уничтожении
// 4. Double-Free при повторном уничтожении
//
// ИНСТРУМЕНТЫ ДЛЯ АНАЛИЗА:
// - ThreadSanitizer: g++ -fsanitize=thread -g singleton_vulnerabilities.cpp
// - AddressSanitizer: g++ -fsanitize=address -g singleton_vulnerabilities.cpp
// - Valgrind: valgrind --tool=helgrind ./singleton_vulnerabilities
//
