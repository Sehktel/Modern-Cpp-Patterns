# РђРЅР°Р»РёР· Р±РµР·РѕРїР°СЃРЅРѕСЃС‚Рё РїР°С‚С‚РµСЂРЅР° flyweight

## РћР±Р·РѕСЂ СѓСЏР·РІРёРјРѕСЃС‚РµР№

### РћСЃРЅРѕРІРЅС‹Рµ С‚РёРїС‹ СѓСЏР·РІРёРјРѕСЃС‚РµР№ РІ flyweight:
...
- **Clang Static Analyzer**: `clang --analyze flyweight_vulnerabilities.cpp`
- **Cppcheck**: `cppcheck --enable=all flyweight_vulnerabilities.cpp`
...
1. **РћР±РЅР°СЂСѓР¶РµРЅРёРµ СѓСЏР·РІРёРјРѕСЃС‚РµР№**:
   ...
   g++ -fsanitize=address -g flyweight_vulnerabilities.cpp -o flyweight_asan
   ./flyweight_asan
   ```

2. **РђРЅР°Р»РёР· СЃ Valgrind**:
   ```bash
   valgrind --tool=memcheck ./flyweight_vulnerabilities
   ```
