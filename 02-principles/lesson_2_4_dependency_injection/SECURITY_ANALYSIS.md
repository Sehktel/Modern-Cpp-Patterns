# РђРЅР°Р»РёР· Р±РµР·РѕРїР°СЃРЅРѕСЃС‚Рё РїР°С‚С‚РµСЂРЅР° dependency_injection

## РћР±Р·РѕСЂ СѓСЏР·РІРёРјРѕСЃС‚РµР№

### РћСЃРЅРѕРІРЅС‹Рµ С‚РёРїС‹ СѓСЏР·РІРёРјРѕСЃС‚РµР№ РІ dependency_injection:
...
- **Clang Static Analyzer**: `clang --analyze dependency_injection_vulnerabilities.cpp`
- **Cppcheck**: `cppcheck --enable=all dependency_injection_vulnerabilities.cpp`
...
1. **РћР±РЅР°СЂСѓР¶РµРЅРёРµ СѓСЏР·РІРёРјРѕСЃС‚РµР№**:
   ...
   g++ -fsanitize=address -g dependency_injection_vulnerabilities.cpp -o dependency_injection_asan
   ./dependency_injection_asan
   ```

2. **РђРЅР°Р»РёР· СЃ Valgrind**:
   ```bash
   valgrind --tool=memcheck ./dependency_injection_vulnerabilities
   ```
