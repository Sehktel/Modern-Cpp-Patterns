# РђРЅР°Р»РёР· Р±РµР·РѕРїР°СЃРЅРѕСЃС‚Рё РїР°С‚С‚РµСЂРЅР° dry_kiss_yagni

## РћР±Р·РѕСЂ СѓСЏР·РІРёРјРѕСЃС‚РµР№

### РћСЃРЅРѕРІРЅС‹Рµ С‚РёРїС‹ СѓСЏР·РІРёРјРѕСЃС‚РµР№ РІ dry_kiss_yagni:
...
- **Clang Static Analyzer**: `clang --analyze dry_kiss_yagni_vulnerabilities.cpp`
- **Cppcheck**: `cppcheck --enable=all dry_kiss_yagni_vulnerabilities.cpp`
...
1. **РћР±РЅР°СЂСѓР¶РµРЅРёРµ СѓСЏР·РІРёРјРѕСЃС‚РµР№**:
   ...
   g++ -fsanitize=address -g dry_kiss_yagni_vulnerabilities.cpp -o dry_kiss_yagni_asan
   ./dry_kiss_yagni_asan
   ```

2. **РђРЅР°Р»РёР· СЃ Valgrind**:
   ```bash
   valgrind --tool=memcheck ./dry_kiss_yagni_vulnerabilities
   ```
