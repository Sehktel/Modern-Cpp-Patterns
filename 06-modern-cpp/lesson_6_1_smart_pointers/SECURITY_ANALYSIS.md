# РђРЅР°Р»РёР· Р±РµР·РѕРїР°СЃРЅРѕСЃС‚Рё РїР°С‚С‚РµСЂРЅР° smart_pointers

## РћР±Р·РѕСЂ СѓСЏР·РІРёРјРѕСЃС‚РµР№

### РћСЃРЅРѕРІРЅС‹Рµ С‚РёРїС‹ СѓСЏР·РІРёРјРѕСЃС‚РµР№ РІ smart_pointers:
...
- **Clang Static Analyzer**: `clang --analyze smart_pointers_vulnerabilities.cpp`
- **Cppcheck**: `cppcheck --enable=all smart_pointers_vulnerabilities.cpp`
...
1. **РћР±РЅР°СЂСѓР¶РµРЅРёРµ СѓСЏР·РІРёРјРѕСЃС‚РµР№**:
   ...
   g++ -fsanitize=address -g smart_pointers_vulnerabilities.cpp -o smart_pointers_asan
   ./smart_pointers_asan
   ```

2. **РђРЅР°Р»РёР· СЃ Valgrind**:
   ```bash
   valgrind --tool=memcheck ./smart_pointers_vulnerabilities
   ```
