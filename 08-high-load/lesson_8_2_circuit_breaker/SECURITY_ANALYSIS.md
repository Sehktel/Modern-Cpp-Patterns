# РђРЅР°Р»РёР· Р±РµР·РѕРїР°СЃРЅРѕСЃС‚Рё РїР°С‚С‚РµСЂРЅР° circuit_breaker

## РћР±Р·РѕСЂ СѓСЏР·РІРёРјРѕСЃС‚РµР№

### РћСЃРЅРѕРІРЅС‹Рµ С‚РёРїС‹ СѓСЏР·РІРёРјРѕСЃС‚РµР№ РІ circuit_breaker:
...
- **Clang Static Analyzer**: `clang --analyze circuit_breaker_vulnerabilities.cpp`
- **Cppcheck**: `cppcheck --enable=all circuit_breaker_vulnerabilities.cpp`
...
1. **РћР±РЅР°СЂСѓР¶РµРЅРёРµ СѓСЏР·РІРёРјРѕСЃС‚РµР№**:
   ...
   g++ -fsanitize=address -g circuit_breaker_vulnerabilities.cpp -o circuit_breaker_asan
   ./circuit_breaker_asan
   ```

2. **РђРЅР°Р»РёР· СЃ Valgrind**:
   ```bash
   valgrind --tool=memcheck ./circuit_breaker_vulnerabilities
   ```
